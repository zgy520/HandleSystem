 ...
 */
@Slf4j
public abstract class BaseUpdateController<T,U> extends BaseController<T> {
    private final UpdateService updateService;
    private final QueryService queryService;
    public BaseUpdateController(UpdateService updateService, QueryService queryService) {
