...
@Service
@Slf4j
public class DepartmentPostServiceBase extends BaseSystemService<DepartmentPost,DepartmentPost> {
    private DepartmentPostRepository departmentPostRepository;
    public DepartmentPostServiceBase(DepartmentPostRepository departmentPostRepository) {
