...
@Slf4j
public class DepartmentControllerBase extends BaseSystemController<Department,DepartmentDTO> {
    private DepartmentServiceBase departmentService;
    @Autowired
    private DepartMapper departMapper;

    public DepartmentControllerBase(DepartmentServiceBase departmentService) {
