...
@Service
@Slf4j
public class EnterpriseServiceBase extends BaseSystemService<Enterprise,EnterpriseDTO> {
    private EnterpriseRepository enterpriseRepository;
    @Autowired
    private IndustryServiceBase industryService;
    public EnterpriseServiceBase(EnterpriseRepository enterpriseRepository) {
