...
@Slf4j
public abstract class BaseQueryServiceImpl<T,U> extends BaseServiceImpl<T> implements QueryService<T,U> {


    private final QueryRepository queryRepository;
    @Autowired
    public BaseQueryServiceImpl(QueryRepository queryRepository) {
