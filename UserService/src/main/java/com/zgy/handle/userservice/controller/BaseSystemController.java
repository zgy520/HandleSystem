...
@Slf4j
public abstract class BaseSystemController<T,U> {
    private final BaseSystemService systemRefactorService;

    private String sortedField = "updateTime"; // 排序字段，默认为更新时间

    @Autowired
    public BaseSystemController(BaseSystemService systemRefactorService){
