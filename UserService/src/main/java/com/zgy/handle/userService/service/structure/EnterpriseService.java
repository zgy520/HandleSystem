...
@Service
@Slf4j
public class EnterpriseService extends SystemService<Enterprise> {
     ...
     * @return
     */
    public Page<Enterprise> findByDynamicQuery(EnterpriseDTO enterpriseDTO, Pageable pageable){
