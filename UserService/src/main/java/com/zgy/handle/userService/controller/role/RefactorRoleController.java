...
import com.zgy.handle.userService.service.authority.RoleRefactorService;
...
@RequestMapping(value = "roleRefactor")
@RestController
public class RefactorRoleController extends SystemController<Role, RoleDTO> {
    private RoleRefactorService refactorService;
    @Autowired
    private RoleMapper roleMapper;
    @Autowired
    public RefactorRoleController(RoleRefactorService refactorService) {
